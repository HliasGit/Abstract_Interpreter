...
struct ASTNode {
    ...
    BinOp getValueBinOp() const {
        return std::get<BinOp>(value);
    }
    ...
    int getChildernValueInt(int i) const {
        return std::get<int>(children[i].value);
    }

    std::string getChildernValueString(int i) const {
        return std::get<std::string>(children[i].value);
    }

    BinOp getChildernValueBinOp(int i) const {
        return std::get<BinOp>(children[i].value);
    }

    VType getChildrenValue(int i) const {
